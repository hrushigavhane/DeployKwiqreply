...
def send_template(request):
    ...
    payload = '{"to": "91'+ str(to) +'", "type": "template", "template": {"namespace": "8533d4ae_209a_48c4_847c_8b7e0bb86430", "name": "vk_welcome", "language": {"policy": "deterministic", "code": "en"}, "components": [{"type": "header", "parameters": [{"type": "image", "image": {"id": "dab0564f-6496-4f12-9cf1-58d64caba8b0"}}]}, {"type": "body", "parameters": [{"type": "text", "text": "*'+param1+'*"}, {"type": "text", "text": "*'+param2+'*"}, {"type": "text", "text": "*'+param3+'*"}]}, {"type": "button", "sub_type": "quick_reply", "index": "1", "parameters": [{"type": "payload", "payload": "Know more"}]}]}} '
